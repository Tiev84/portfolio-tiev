                ...
                helper.write_text(
                    "\n".join(
                        [
                            ...
                            'echo "======================================================"',
                            'echo "  ĐĂNG NHẬP GITHUB (chỉ làm một lần)"',
                            'echo "======================================================"',
                            "echo",
                            'echo "Nếu được hỏi:"',
                            'echo "  Username : tên đăng nhập GitHub của bạn"',
                            'echo "  Password : DÁN Personal Access Token vào đây"',
                            'echo "             (KHÔNG phải mật khẩu GitHub — GitHub đã bỏ)"',
                            'echo "             tạo ở github.com/settings/tokens, tick quyền repo"',
                            "echo",
                            'echo "*** LƯU Ý QUAN TRỌNG ***"',
                            'echo "Khi gõ hoặc dán mật khẩu, màn hình KHÔNG hiện gì cả:"',
                            'echo "không dấu sao, không dấu chấm, con trỏ đứng yên."',
                            'echo "Terminal hiện hình CHÌA KHOÁ để báo đang che kín."',
                            'echo "Đó là bình thường, KHÔNG phải bị treo."',
                            'echo "Cứ bấm Cmd+V để dán rồi bấm Enter."',
                            "echo",
                            "git push",
                            "echo",
